      ...
      <div class="col-md-12 gedf-main">
        <form action="#" id="payment_form">
          ...
          <div class="row align-items-center">
            <div class="form-group col-md-6">
              ...
              <input type="email" class="form-control" id="amount" name="amount" placeholder="Amount" value="10.00">
              </div>
        ...
        <div class="row justify-content-start">
          <div class="col text-center">
            <button type="submit" class="btn btn-primary mt-4" onclick="launchBOLT(); return false;">Pay Now</button>
          </div>
        </div>
